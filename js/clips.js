			...
			if (video.type == "youtube") {
				...
				<div class="vid-direct">
					...
					<div id="vid-desc">${video.description ? `"${video.description}"` : ""}</div>
						...
						<br>
						<p id="video-is-unavailable">⚠️ If the player shows "This video is unavailable", refresh the page and the clip should load.<br>❗ For the best viewing experience, set the playback quality to 1440p60<sup>HD</sup> or 1080p60<sup>HD</sup> (if available).</p>
